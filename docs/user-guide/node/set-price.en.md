...
Set the hourly usage fee for your shared GPU.

!!! tip
    Pricing is applied independently per GPU. You can only set a price within the allowed price range.
...
| **Status** | **Message Displayed** | **Action** |
| --- | --- | --- |
| Amount same as default | Same as the default value. | Enter a different amount |
| Amount exceeds or falls below the allowed range | Price range guidance message displayed | Re-enter an amount within the indicated range |
