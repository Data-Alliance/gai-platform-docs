...
실제 등록 방법은 [새 워크로드 등록](https://data-alliance.github.io/gai-platform-docs/user-guide/workload/register-new-workload/) 문서를 참고해 주세요. <br><br>
...
※ Pytorch 2.7.0 버전은 Nvidia의 blackwell 아키텍처에 맞춰 급하게 개발된 nightly 버전으로 일관된 성능을 보이지 않을 수도 있습니다.

이전 버전의 Pytorch를 사용하고 싶으시다면 `koojy717/lora-tuning:1.02` 이미지를 이용하시면 되겠습니다.<br><br>  ※Pytorch 2.01(CUDA 11.8 지원) 사용

### **워크로드 설정 가이드**

![워크로드등록예시_20251210_01.png](img/example-workload/워크로드등록예시_20251210_01.png)
