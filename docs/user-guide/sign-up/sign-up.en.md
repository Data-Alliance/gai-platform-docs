...
![005_sign-up.png](img_en/sign-up/005_sign-up.png)
2. After logging in, you will be redirected to the gcube console.
![006_sign-up.png](img_en/sign-up/006_sign-up.png)
...
[Next: Profile Setup →](profile-settings.en.md){ .md-button .md-button--primary }
</div>